...
// Source: ./sanity/schemaTypes/queries.ts
// Variable: STARTUPS_QUERY
// Query: *[_type =='startup' && defined(slug.current) && defined(slug.current) && !defined($search) || title match $search || category match $search || author->name match $search] | order(_createdAt desc) {    _id ,    title ,     slug,    _createdAt ,    author ->  {      _id , name , image , bio     },    views,    description ,     category ,    image}
...
// Query: *[_type =='startup' && _id==$id][0] {  _id ,    title ,     slug,    _createdAt ,    author ->  {      _id , name , image , bio     },    views,    description ,     image ,    pitch }
...
// Query: *[_type=='author' && githubId==$id][0] {  _id ,  id ,   name ,  bio ,   image ,   email }
